...
\begin{theorem}
	...
	if
	\[
		p \gg \bigg(\frac{\log n}{n}\bigg)^\Delta
	\]
	then
	\[
...
I wasn't really nitty picky on proving that Hall's hold with high probability here, as it is not
the crux of the proof. But I will do it for completion.

\begin{lemma}
	Let $(A,B)$ be a bipartite graph with $|A| = |B|$
\end{lemma}
