...
\begin{proof}[Proof of \ref{prop:main_prop_chr_concentration}]
	...
	clever counting argument.

	Suppose $\delta < 1/5$, and again, for each $i$ choose $C_i \subset
	...
	(I don't know if I will be able to present this) Now for the less
	intuitive part, if $\delta > 1/5$.
\end{proof}
